...
**Rule**: Never use bold text (`**text**`) as a heading substitute. Always use
...
3. **Emphasis for structure** - Use headings for document structure, bold only
   for emphasis within content
